<template>
  <div id="remap" style="width: 1920px;height: 800px;">
    ...
    <panel v-if="isFlag.airPlan" @ms="ms" @kg = 'kg' @yy="yy" @or="or" :isRe="isRe" :T="T" :isOpen="isOpen" :isAi="isAi" @patternChange="patternChange" @tChange="tChange" :pattern="pattern" style="position: absolute;z-index: 101;opacity: .9;" :style="{top: (isFlag.Y) +'px', left: (isFlag.X + 100) +'px'}"></panel>
