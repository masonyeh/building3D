...
msj3D.prototype.InitAddObject = function (_obj) {
    ...
    if (_obj.show == null || typeof (_obj.show) == 'undefined' || _obj.show) {
        ...
        switch (_obj.objType) {
          ...
          //   break;
          // case 'smokeDetector' :
          //   _tempObj = _this.addSmokeDetector (_this, _obj);
          //   _this.addObject(_tempObj);
          //   break;
          }
    }
...
// 添加单人床
msj3D.prototype.addSingleBed = function (_this, _obj) {
...
// 烟感器
// msj3D.prototype.addSmokeDetector = function (_this, _obj) {
//   var FBXloader = new THREE.FBXLoader()
...
//     // object.repeat.set(1, 1);
//     object.scale.multiplyScalar(1);
//     object.name = _obj.name
//     object.type = _obj.objType
//     console.log(object)
//     _this.objects.push(object);
//     _this.scene.add(object)
//     // _this.addObject(_obj)
//   })
// }
// 创建床
msj3D.prototype.addSingleBed = function (_this, _obj) {
  var ThreeMFLoader = new THREE.ThreeMFLoader()
  ThreeMFLoader.load('./obj/Windmill.3mf', function (object) {
    // object.scale.multiplyScalar(.1);    // 缩放模型大小
    console.log(object)
    // object.repeat.set(1, 1);
