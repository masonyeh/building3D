...
w3dshow.prototype.createPlaneGeometry = function (_this,_obj) {
    ...
    502     plane.rotation.z = options.rotation.z;
    return plane;
}
//创建空柜子
    ...
    if (_obj.doors != null && typeof (_obj.doors) != 'undefined') {
        ...
        if (doors.skins.length == 1) {//单门
            var singledoorobj = {
                ...
                y: _obj.position.y,
                672             tempobj.add(singledoorcube);
        ...
        if (_obj.repeaty != null && typeof (_obj.repeaty) != 'undefined' && _obj.repeaty == true) {
            ...
            _repeat = true;  736         if (_this.commonFunc.hasObj(_obj.imgurl)) {
                return {
                ...
                770         $.each(_this.objects, function (index,_obj) {
